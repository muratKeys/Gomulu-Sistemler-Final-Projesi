/*
file: rpi_gpio_encoder_module.c
quadrature/IRC sensör arayüzü yazılımı çekirdek sürücü uygulaması sadece kod çözücü. Sensör çıkışları GPIO pinlerine bağlanır.
*/
